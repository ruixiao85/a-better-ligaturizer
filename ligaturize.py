...
config = {
	...
	'add_ligatures': [
		...
		{ 'chars': ['less', 'equal'], 'firacode_ligature_name': 'equal_less.liga',},  # <=
		...
		{ 'chars': ['slash', 'asterisk', 'asterisk'], 'firacode_ligature_name': 'slash_asterisk_asterisk.liga',},  # /**
		...
		{ 'chars': ['equal', 'asciitilde'], 'firacode_ligature_name': 'equal_asciitilde.liga',},  # =~
